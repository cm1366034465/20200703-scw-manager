        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post" action="${PATH}/admin/saveAdmin">
                        <div class="form-group">
                            <label for="exampleInputPassword1">登陆账号</label>
                            <input id="exampleInputPassword1"  name="loginacct" type="text" class="form-control"  placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword2">用户名称</label>
                            <input id="exampleInputPassword2"  name="username" type="text" class="form-control" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword3">用户密码</label>
                            <input type="text" class="form-control" name="userpswd" id="exampleInputPassword3" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
